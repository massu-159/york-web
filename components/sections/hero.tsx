...
export function Hero() {
  return (
    <section className='relative min-h-screen py-20 flex items-center px-4' role="banner" aria-label="メインビジュアル">
      ...
      <div className='relative z-20 max-w-3xl mx-auto ml-4 md:ml-20'>
        ...
        <p className='text-muted-foreground mb-8 max-w-2xl'>
          We support your business growth with cutting-edge technology and creative design that transforms your ideas
