...
export function Navigation() {
  ...
  const navItems = [
    ...
    { href: "#services", label: "Services", ariaLabel: "サービスセクションへ移動" },
    { href: "#portfolio", label: "Portfolio", ariaLabel: "ポートフォリオセクションへ移動" },
    { href: "#about", label: "About", ariaLabel: "会社概要セクションへ移動" },
    { href: "#contact", label: "Contact", ariaLabel: "お問い合わせセクションへ移動" }
  ];
  ...
  useEffect(() => {
    const navLinks = navigationRef.current?.querySelectorAll('a[data-nav-item]');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="#" className="text-xl font-semibold" aria-label="ホームページへ戻る">
